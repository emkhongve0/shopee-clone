    ...
    <div class="fixed inset-y-0 right-0 flex max-w-full pl-10">
        <div class="w-screen max-w-md transform transition duration-500 ease-in-out shadow-2xl" x-show="isPanelOpen"
            ...
            <div
                ...
                {{-- Nội dung (Content) --}}
                <div class="p-6 space-y-6" x-show="selectedUser" x-cloak>
                    ...
                    <div class="text-center">
                        <div
                            ...
                            <span class="text-white font-extrabold text-3xl"
                                x-text="selectedUser?.name.split(' ').map(n => n[0]).join('').slice(0, 2).toUpperCase()">
                            </span>
                        </div>
                            ...
                            <span class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border"
                                :class="{
                                    ...
                                    'bg-orange-500/10 text-orange-500 border-orange-500/20': selectedUser
                                        ?.status === 'inactive',
                                    'bg-red-500/10 text-red-500 border-red-500/20': selectedUser?.status === 'banned'
                                }"
                                x-text="selectedUser?.status === 'active' ? 'Hoạt động' : (selectedUser?.status === 'inactive' ? 'Chờ' : 'Đã khóa')"></span>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-800/40 rounded-2xl p-5 space-y-4 border border-slate-800/50">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0">
                                <p class="text-slate-500 text-[11px] uppercase font-bold tracking-widest mb-0.5">Địa chỉ
                                    Email</p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-slate-500 text-[11px] uppercase font-bold tracking-widest mb-0.5">Số điện
                                    thoại</p>
                                <p class="text-white text-sm font-medium" x-text="selectedUser?.phone"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-800/40 rounded-2xl p-5 space-y-4 border border-slate-800/50">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-slate-500 text-[11px] uppercase font-bold tracking-widest mb-0.5">Thành
                                    viên từ</p>
                    ...
                    {{-- Hoạt động & Thống kê (Activity & Stats) --}}
                    <div class="grid grid-cols-2 gap-4">
                        <div
                            ...
                            <p class="text-slate-500 text-[10px] uppercase font-bold tracking-wider">Tổng đơn hàng</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-slate-500 text-[10px] uppercase font-bold tracking-wider">Tổng chi tiêu</p>
                        </div>
                    </div>

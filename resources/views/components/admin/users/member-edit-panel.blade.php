            ...
            <div
                ...
                <div class="p-6 space-y-6" x-show="selectedUser">
                    ...
                    <div class="bg-blue-600/5 p-5 rounded-3xl border border-blue-500/10 space-y-4">
                        <h4 class="text-blue-400 text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            <i class="fas fa-chart-line"></i> Dữ liệu giao dịch
                        </h4>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" x-model="selectedUser.orders"
                                    class="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2 text-white font-bold text-sm">
                            </div>
                            <div>
                                ...
                                <input type="text" x-model="selectedUser.totalSpent"
                                    class="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2 text-emerald-400 font-bold text-sm">
                            </div>
                        </div>
                    </div>
